  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        id: 5,
        stepNumber: 2,
        instruction: "Mash avocado lightly with a pinch of salt and spread over toast.",
        timingTag: "DayOfActive",
        durationMinutes: 4,
        isPassive: false,
      },
      {
        id: 6,
        stepNumber: 3,
        instruction: "Choose any add-ons you want and layer them on top before serving.",
        timingTag: "DayOfActive",
        durationMinutes: 2,
        isPassive: false,
      },
